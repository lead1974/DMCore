        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SortSeq = table.Column<int>(nullable: false),
                    PublicCategory = table.Column<bool>(nullable: false),
                    CreatedBy = table.Column<string>(nullable: true),
                    CreatedTS = table.Column<DateTime>(nullable: false),
                    UpdatedBy = table.Column<string>(nullable: true),
                    UpdatedTS = table.Column<DateTime>(nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreTips = table.Column<string>(maxLength: 255, nullable: false),
                    Image = table.Column<byte[]>(nullable: true),
                    ImageContentType = table.Column<string>(nullable: true),
                    CreatedBy = table.Column<string>(nullable: true),
                    CreatedTS = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stores_DealCategories_DealCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTS = table.Column<DateTime>(nullable: false),
                    EndTS = table.Column<DateTime>(nullable: false),
                    ...
                    UpdatedBy = table.Column<string>(nullable: true),
                    UpdatedTS = table.Column<DateTime>(nullable: false),
                    DealCategoryId = table.Column<long>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Coupons_DealCategories_DealCategoryId",
                        column: x => x.DealCategoryId,
                        principalTable: "DealCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<byte[]>(nullable: true),
                    ImageContentType = table.Column<string>(nullable: true),
                    DMProduct = table.Column<bool>(nullable: false),
                    StartTS = table.Column<DateTime>(nullable: false),
                    EndTS = table.Column<DateTime>(nullable: false),
                    Approved = table.Column<bool>(nullable: false),
                    Status = table.Column<int>(nullable: false),
                    ...
                    StoreId = table.Column<long>(nullable: false),
                    DealCategoryId = table.Column<long>(nullable: true),
                    DealTagId = table.Column<long>(nullable: false),
                    AffiliateSiteId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deals_DealTags_DealTagId",
                        column: x => x.DealTagId,
                        principalTable: "DealTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Coupons_DealCategoryId",
                table: "Coupons",
